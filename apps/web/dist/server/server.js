...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DIMR-n7H.js");
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-6tBd5Pa3.js").then((n2) => n2.x);
