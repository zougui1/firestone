  ...
  data: z
    .object({
      ...
      mission: z.object({
        ...
        difficulty: z.enum(
          difficulties as [CampaignDifficulty, ...CampaignDifficulty[]],
        ),
      }),
      rounds: z.number(),
...
export const invokeSimulateDetailedMission = (
  ...[summary, warMachines, options]: Parameters<typeof simulateDetailedMission>
) => {
