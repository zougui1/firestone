...
const missionsList = [
  ...
  [
    ...
    {
      id: 33,
      name: 'The Resistance of Goldfell',
      type: missionTypes.adventure,
    },
  ...
  // titan missions
  [{ id: 67, name: 'Guardian of Doomfire', type: missionTypes.titan }],

  // unknown missions
  [
    { id: 50, name: '', type: missionTypes.scout },
    { id: 61, name: 'unknown', type: missionTypes.titan },
    { id: 62, name: 'unknown', type: missionTypes.titan },
    { id: 63, name: 'unknown', type: missionTypes.titan },
    { id: 64, name: 'unknown', type: missionTypes.titan },
    { id: 65, name: 'unknown', type: missionTypes.titan },
    { id: 66, name: 'unknown', type: missionTypes.titan },
  ],
];

const missionsMap = new Map(
  missionsList.flat().map((mission) => [mission.id, mission]),
);

export const missions = {
  types: missionTypes,
  list: missionsList,
  flatList: missionsList.flat(),
  map: missionsMap,
};

export type Mission = (typeof missionsList)[number][number];
